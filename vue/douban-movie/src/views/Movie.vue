  ...
  <transition name="fade">
    <div class="movie">
      <div class="player-wrapper" @touchmove.prevent>
        ...
        <video class="player" :src="movie.video" controls="controls"></video>
      ...
      <div class="info-wrapper">
        <scrollView :data="relativeMovies">
          ...
          <div class="space" style="background-color: #f6f6f6; width: 100%; height: 10px;"></div>
          ...
          <div class="loding-wrap" v-if="!relativeMovies"></div>
        </scrollView>
...
export default {
  ...
  computed: {
    desc() {
      ...
      this.movie.pubdate.replace('（中国大陆）','')
      const rate = this.movie.rate ? `${this.movie.rate}分` : '即将上映'

      // const movieType = this.movieType
